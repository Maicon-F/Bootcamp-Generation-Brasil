...
public class CestaSolidaria {
	...
	EstoqueProdutosEssenciais meuEstoque = new EstoqueProdutosEssenciais(nome, produto, estoque, cb1);
	...
	public void mostrarMenuPrincipal() {
		...
		while (true) {
			System.out.println("*********************************************");
			System.out.println("\tCESTA SOLIDARIA 2021 ");
			System.out.println("*********************************************\n");
	...
	private void deletePersistent(EstoqueProdutosEssenciais meuEstoque2) {
	...
	public void escolherFinanceiro() {
		...
		estoque.add(1000);
		cb1.add(400);		
		EstoqueDinheiro meuEstoque = new EstoqueDinheiro(nome, produto, estoque, cb1);
		meuEstoque = null;
		controlarDoacao();
	}
	...
	public static void main(String[] args) {
		CestaSolidaria cesta = new CestaSolidaria();
